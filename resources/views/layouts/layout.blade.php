        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo menu">
            <a href="/" class="app-brand-link">
              ...
              <span class="app-brand-logo demo">
                <img src="{{ asset('assets/img/logo.jpeg')}}" width="170" alt="">
              </span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item open active" style="">
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="/class/4" class="menu-link">
                    <div>2021 A</div>
                  </a>
                </li>
              </ul>
            ...
            @if(Auth::user()->role == 3)
            <li class="menu-item">
              <a href="/fill-krs/{{$token ?? ''}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-border-all"></i>
                <div data-i18n="Analytics">Fill KRS</div>
              </a>
            </li>
            @endif
            @php
